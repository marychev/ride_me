...
class RightPanelBtn(PanelBtn):
    ...
    def change_character_wrap(character_wrap, value):
        progress_bar = character_wrap.children[1].children[0]
        char_btns = [character_wrap.children[2].children[0], character_wrap.children[2].children[2]]
        character_wrap.value = progress_bar.value = int(value)
        character_wrap.max = progress_bar.max = int(value)
        char_btns[0].disabled = char_btns[1].disabled = False
        char_btns[0].opacity = char_btns[1].opacity = 1
